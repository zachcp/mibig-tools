...
def process_taxonomy(tax):
    ...
    if len(taxonomy) == 7:
        #classic texonomy
        k,p,c,o,f,g,s =  taxonomy

    elif len(taxonomy) == 12:
        # extended taxonomy
        k,p,c,o,f,subfam,tribe,subtribe,g,subgenus,s,subspecies = taxonomy
    ...
    ######################################################################
        ...
        if taxonomy == tax1 or tax3:
            # extended taxonomy
            k,p,o,g = taxonomy
            c,f,s = ["Unknown","Unknown", "Unknown"]
        elif taxonomy == tax2:
            k,p,c,g = taxonomy
            o,f,s = ["Unknown","Unknown", "Unknown"]
    ...
    # Print Errors: You Shouldn't Get Here
    ######################################################################
    ######################################################################
